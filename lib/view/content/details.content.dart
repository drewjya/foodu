    ...
    return NewScaffold(
      ...
      body: CustomScrollView(
        slivers: [
              ...
              children: [
                Center(
                  child: ClipRRect(
                    ...
                    child: Obx(
                      () => Image.network(
                        detailsController.argument!.value.imglink,
                        fit: BoxFit.cover,
                        width: 280,
                        height: 320,
                      ),
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Obx(
                        () => InkWell(
                          onTap: () {
                            detailsController.onChange();
                          },
                          child: Icon(
                            (detailsController.favorited!.value)
                                ? Icons.favorite
                                : Icons.read_more,
                          ),
                        ),
          ...
          //     height: 100,
          //     child: Obx(() =>
          //         Text(detailsController.containing!.value.length.toString())),
          //   ),
          // )
        ],
      ),
